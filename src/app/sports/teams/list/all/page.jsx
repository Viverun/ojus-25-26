...
//                 className="w-full bg-slate-900/50 border border-slate-800 text-slate-200 pl-10 pr-4 py-3 rounded-xl focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition-all placeholder:text-slate-600 backdrop-blur-sm"
//               />
//             </div>
//
//             {/* Create Button */}
...
//               className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 text-white font-semibold py-3 px-6 rounded-xl transition-all shadow-lg shadow-purple-900/20 hover:shadow-purple-900/40 active:scale-95 whitespace-nowrap"
//             >
...
//         {/* Content Section */}
//         {teams.length === 0 ? (
//           // Empty State: No teams in DB
//           <div className="flex flex-col items-center justify-center py-24 px-4 text-center bg-slate-900/30 border border-dashed border-slate-800 rounded-3xl">
...
//              </div>
//              <p className="text-lg text-slate-300 font-medium">No matches found</p>
//              <p className="text-slate-500">We couldn't find any team or sport matching "{searchTerm}"</p>
//              <button
...
//             {filteredTeams.map((t) => (
//               <div key={t.id} className="transition-transform hover:-translate-y-1 duration-300 h-full">
//                 <TeamCard team={t} />
//               </div>
//             ))}
//           </div>
