...
export default function AdminPage(){
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <a href="/" className="inline-block bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-lg">
            Back to Home
          </a>
        </div>
      </div>
  ...
  const adminControls = [
    ...
    },
    {
      ...
      controls: [
        { label: "View All Registrations", url: "/sports/registration/list/all", icon: "📝", desc: "Manage all event registrations" },
        { label: "User Registrations", url: "/sports/registration/user_register_sports", icon: "🔍", desc: "Search and view user registrations" },
      ]
    },
    {
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white py-12 px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-400 text-lg">Welcome, {user?.first_name || user?.username}! Manage sports events, teams, and registrations.</p>
        </div>
        ...
        <div className="space-y-12">
          {adminControls.map((section, idx) => (
            <div key={idx}>
              <h2 className="text-2xl font-bold text-purple-400 mb-6 uppercase tracking-wider">
                {section.category}
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {section.controls.map((control, cidx) => (
                  <button
                    key={cidx}
                    onClick={() => router.push(control.url)}
